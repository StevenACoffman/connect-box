...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/Khan/hackathon-khanmigogo/server/chat/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	ChatServiceName = "server.chat.v1.ChatService"
)
...
const (
	...
	// NewChatSession RPC.
	ChatServiceNewChatSessionProcedure = "/server.chat.v1.ChatService/NewChatSession"
	// ChatServiceBroadcastChatProcedure is the fully-qualified name of the ChatService's BroadcastChat
	// RPC.
	ChatServiceBroadcastChatProcedure = "/server.chat.v1.ChatService/BroadcastChat"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	chatServiceServiceDescriptor              = v1.File_server_chat_v1_chat_proto.Services().ByName("ChatService")
...
// ChatServiceClient is a client for the server.chat.v1.ChatService service.
...
// NewChatServiceClient constructs a client for the server.chat.v1.ChatService service. By default,
...
// NewChatSession calls server.chat.v1.ChatService.NewChatSession.
...
// BroadcastChat calls server.chat.v1.ChatService.BroadcastChat.
...
// ChatServiceHandler is an implementation of the server.chat.v1.ChatService service.
...
func NewChatServiceHandler(svc ChatServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/server.chat.v1.ChatService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedChatServiceHandler) NewChatSession(context.Context, *connect.Request[v1.NewChatSessionRequest], *connect.ServerStream[v1.NewChatSessionResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("server.chat.v1.ChatService.NewChatSession is not implemented"))
}
...
func (UnimplementedChatServiceHandler) BroadcastChat(context.Context, *connect.Request[v1.BroadcastChatRequest]) (*connect.Response[v1.BroadcastChatResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("server.chat.v1.ChatService.BroadcastChat is not implemented"))
}
